...
class DemoBaseViewController: UIViewController, ChartViewDelegate {
    ...
    func setup(pieChartView chartView: PieChartView) {
        ...
        //let sumMesages = messagesMachineManager.chartsData.compactMap({ Double($0.value) }).reduce(0, +)
        
        let centerText = NSMutableAttributedString(string: " Number of Messages\nby category")
        //let centerText = NSMutableAttributedString(string: "  Total messages: \(Int(sumMesages))")
